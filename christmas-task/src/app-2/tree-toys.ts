...
import { ICard, IToy } from '../app-1/interfaces';
...
export class TreeToys {
  ...
  private toysContainer = document.querySelector('.toys__container');
  ...
  private createToyBox(toy: ICard | IToy): void {
    ...
    toyBox.className = 'tree-toy menu-item';
    ...
    while (i < +toy.count) {
      ...
      toyImage.src = `https://raw.githubusercontent.com/ixakina/christmas-task-assets/master/assets/toys/${toy.num}.png`;
